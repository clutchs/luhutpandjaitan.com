<?php include 'head.php';?>
    ...
    <div class="container full-width">
      ...
      <div class="main-photo">
        ...
        <blockquote>
          <p class="hilights dearjoe_5_dearjoe5casualtrial">
      ...
      <div class="row quotes-home apollo-hover">
        ...
        <figure class="effect-apollo col-xs-12 col-sm-12 col-md-6 col-lg-6">
          <img class="profile-photo-homepage img-responsive" src="img/pemikiran-hompage.jpg" alt="pemikiran Luhut Panjaitan">
          <figcaption>
      ...
      <div class="pemikiran row apollo-hover">
        ...
        <figure class="effect-apollo col-xs-12 col-sm-12 col-md-6 col-lg-6">
          <img class="profile-photo-homepage img-responsive" src="img/profile-home-photo.jpg" alt="photo profile luhut at homepage">
          <figcaption>
            <h2 class="heading-profile-home">Profile</h2>
            <p>Profile</p>
            <a href="#">Profile</a>
          </figcaption>
        </figure>
        ...
        <div id="pemikiran-home" class="profile-homepage col-xs-12 col-sm-12 col-md-8 col-lg-8">
          ...
          <img class="profile-photo-homepage img-responsive" src="img/photo-pemikiran-homepage.jpg" alt="pemikiran Luhut Panjaitan">
          </a>
        </div>
