...
<html lang="en">
      ...
      <div class="bg-yellow row">
        ...
        <div class="mekanisme-body row">
          <ul>
            ...
            <li>Kemasan produk tidak wajib ada di foto</li>
            <li>Si Kecil maksimal berusia 3 tahun sampai dengan akhir Desember 2015</li>
            <li>Satu anak hanya dapat diikutsertakan dalam 1 foto, jika mengirimkan lebih dari 1 foto maka akan didiskualifikasi</li>
  ...
  sumbernya</li>
          ...
          <h2 class="kriteria vag-font">KRITERIA PENILAIAN</h2>
          <ul>
            <li>Keaslian cerita (bukan hasil mengutip dari mana pun)</li>
            <li>Cara penulisan cerita yang menarik dan kreatif</li>
            <li>Kesesuaian foto dengan tema serta cerita yang ditulis</li>
            <li>Ekspresi wajah baik si Kecil atau pun Mamy </li>
            <li>Produk MamyPoko yang digunakan nampak jelas</li>
          </ul>
        </div>
      </div>
    </div> <!-- /container -->
