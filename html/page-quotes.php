    ...
    <div class="container full-width">
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            <ul id="myTabs" class="nav nav-tabs container" role="tablist">
                <li role="presentation" class="active"><a href="#quotes" role="tab" id="quotes-tab" data-toggle="tab" aria-controls="quotes">Quotes</a></li>
                <li role="presentation"><a href="#pemikiran" id="pemikiran-tab" role="tab" data-toggle="tab" aria-controls="pemikiran" aria-expanded="true">Pemikiran</a></li>
            </ul>
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade" id="pemikiran" aria-labelledBy="pemikiran-tab">
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="quotes" aria-labelledBy="quotes-tab">
